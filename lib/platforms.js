...
module.exports = {
    win32: {
        ...
        files: { // First file must be the executable
            ...
            '>0.9.2': ['nw.exe', 'd3dcompiler_47.dll', 'ffmpegsumo.dll', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw.pak', 'locales']
        },
    ...
    linuxARM: {
        ...
        getRunnable: function() { return 'nw'; },
        files: {
            '<=0.9.2': ['nw', 'nw.pak', 'libffmpegsumo.so', 'locales'],
            '>0.9.2': ['nw', 'nw.pak', 'libffmpegsumo.so', 'icudtl.dat', 'locales']
        },
        versionNameTemplate: 'v${ version }/${ name }-v${ version }-linux-armhf.tar.gz'
    }
};
